      ...
      <CardContent className="flex flex-col items-center">
        <div className="mb-8 w-full flex justify-center">
          <Button
            ...
            className="w-48 h-48 rounded-full bg-yellow-500 hover:bg-yellow-400 text-white shadow-lg transition-all duration-300 hover:shadow-yellow-300/50 hover:shadow-xl hover:scale-105 group"
          >
