      ...
      <CardContent className="flex flex-col items-center">
        <div className="mb-8 w-full flex justify-center">
          <Button
            ...
            className="w-48 h-48 rounded-full bg-gradient-to-br from-[#ef4444] to-[#b91c1c] hover:from-[#f87171] hover:to-[#ef4444] shadow-lg transition-all duration-300 hover:shadow-[#ef4444]/20 hover:shadow-xl hover:scale-105 group"
          >
