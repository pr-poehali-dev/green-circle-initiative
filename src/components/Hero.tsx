        ...
        titleComponent={
          <div className="text-center">
            ...
            <p className="text-lg text-gray-500 mb-12 max-w-2xl mx-auto">
              Откройте для себя мир невероятно вкусных пышек: от классических до
              авторских рецептов. Свежие, ароматные, приготовленные с любовью.
              Быстрая доставка прямо к вашему столу.
            </p>
            <RainbowButton
