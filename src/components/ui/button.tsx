...
const buttonVariants = cva(
  ...
  "primary": "bg-primary text-primary-foreground hover:bg-primary/90 neon-border",
  "destructive":
  ...
  "neon": "bg-transparent border border-primary text-primary neon-text neon-border hover:bg-primary/10",
  "neon-accent": "bg-transparent border border-accent text-accent neon-accent hover:bg-accent/10",
},
        icon: "h-10 w-10",
      },
    },
