    ...
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-white dark:bg-neutral-950">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
          ...
          <div className="absolute inset-auto z-50 h-36 w-full -translate-y-1/2 rounded-full bg-neutral-500/30 opacity-50 blur-3xl"></div>
          <div className="absolute inset-auto z-30 h-36 w-[80%] -translate-y-[6rem] rounded-full bg-neutral-400/40 blur-2xl animate-scale-in"></div>
