...
export function Navbar() {
  return (
    <nav className="w-full fixed top-0 left-0 right-0 py-2 px-3 md:px-4 z-50">
      <div className="max-w-4xl mx-auto flex justify-between items-center backdrop-blur-md bg-[#2B3144]/70 rounded-xl shadow-lg border border-[#9b87f5]/30 py-1 px-3 transition-all duration-300 hover:bg-[#2B3144]/80">
