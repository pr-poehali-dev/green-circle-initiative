  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Сэкономили 1,2 млн рублей на материалах и избежали переделок. Квартира продалась на 2,5 млн дороже, чем аналогичные без дизайна. Окупилось в 3 раза.
        </blockquote>
        ...
        >
          ...
          <p className="text-sm text-primary-foreground/60 mt-1">3-комнатная квартира, 95м², Москва</p>
        </div>
      </div>
    </section>
  )
