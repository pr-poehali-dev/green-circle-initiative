          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="md:w-1/2 flex justify-center">
              <div className="relative w-80 h-80">
                ...
                <img
                  src="https://images.unsplash.com/photo-1620705053351-aeb2b836de9a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80"
                  alt="Коктейли с экзотическими фруктами и льдом"
