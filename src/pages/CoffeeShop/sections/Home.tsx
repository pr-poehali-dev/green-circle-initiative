          ...
          <div className="space-y-8 text-left">
              ...
              <h1 className="text-5xl lg:text-6xl font-bold text-white leading-tight tracking-tight animate-slideInFromLeft">
                <div className="relative inline-block mr-3 align-middle">
                  <Icon 
                    name="Coffee" 
                    size={56} 
                    className="text-[#DEB887] relative z-10 animate-[rockCup_3s_ease-in-out_infinite]" 
                  />
                  <div className="absolute -top-2 -left-2 w-[72px] h-[72px] bg-[#4A80BD]/30 rounded-full animate-[rockCup_3s_ease-in-out_infinite_0.2s]"></div>
                  <div className="absolute -top-2.5 -left-2.5 w-[80px] h-[80px] bg-[#DEB887]/20 rounded-full animate-[rockCup_3s_ease-in-out_infinite_0.4s]"></div>
                </div>
            ...
            <div className="flex items-center gap-4 flex-wrap animate-fadeIn animation-delay-600">
              <Button 
                ...
                className="bg-white text-[#1D2B3F] px-6 py-6 rounded-lg 
                hover:bg-gray-100 transition-colors text-lg h-auto font-medium"
              >
