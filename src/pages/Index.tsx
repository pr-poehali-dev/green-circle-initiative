        ...
        <div className="container mx-auto px-8 flex items-center justify-center bg-slate-100">
          ...
          <div className="space-y-8 max-w-xl text-center">
            <div className="space-y-2">
              <h1 className="lg:text-7xl tracking-tight leading-none text-slate-800 text-center text-4.5xl font-extrabold text-4xl">
                АйБло 16 Pro
              </h1>
              <p className="lg:text-3xl leading-tight text-slate-700 font-400 my-1.5 text-center text-2xl">
