...
def handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    if method == 'GET':
        ...
        space_facts = [
            ...
            'В нашей Галактике существует около 400 миллиардов звезд',
            'Отпечаток ботинка космонавта на Луне может сохраниться миллионы лет',
            'Сатурн настолько легкий, что мог бы плавать в воде',
            'На спутнике Юпитера Европе есть океан под ледяной поверхностью'
        ]
