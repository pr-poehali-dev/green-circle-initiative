...
from utils.db import get_connection, escape_string, table
...
def handle(event: dict) -> dict:
    ...
    # Simple Query Protocol with full table name
    check_query = f"SELECT id FROM {table('users')} WHERE email = {escape_string(email)}"
