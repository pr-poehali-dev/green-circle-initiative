...
from utils.unisender import send_login_notification
...
def handle(event: dict, origin: str = '*') -> dict:
    ...
    # Send login notification via Unisender (non-blocking)
    try:
        send_login_notification(user_email, user_name or user_email)
    except Exception:
        pass
